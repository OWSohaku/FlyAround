...
class Site extends \AppBundle\Entity\Site implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Site' . "\0" . 'departures', '' . "\0" . 'AppBundle\\Entity\\Site' . "\0" . 'arrivals', '' . "\0" . 'AppBundle\\Entity\\Site' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Site' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Site' . "\0" . 'icao', '' . "\0" . 'AppBundle\\Entity\\Site' . "\0" . 'latitude', '' . "\0" . 'AppBundle\\Entity\\Site' . "\0" . 'longitude', '' . "\0" . 'AppBundle\\Entity\\Site' . "\0" . 'city'];
        }
